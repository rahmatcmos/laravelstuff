    ...
    <div class="container">
        <div class="row">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown animated" style="visibility: visible;">Vraag offerte
                    aan</h2>
                <p class="text-center wow fadeInDown animated" style="visibility: visible;">Geef hier uw gewenste
                    specificatie of vraag en wij nemen zo spoeding mogelijk contact met u op. Graag vermelden van welk
                    tijdsbestek u de data aangeleverd wilt hebben zodat wij een actuele prijs kunnen opstellen.</p>
            </div>
            <form id="main-contact-form" name="contact-form" method="post" action="#">
                <div class="col-lg-6 animated animate-from-left" style="opacity: 1; left: 0px;">
                    ...
                    <div class="form-group has-feedback">
                        <label for="subject">Productcode (verplicht)</label>
                        <input type="text" id="subject" name="subject" class="form-control" placeholder="Productcode"
                               value="">
